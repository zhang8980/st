    ...
    Eg = {class: "content"}, Mg = {class: "text"}, Lg = zm({
        __name: "Message", setup(e) {
            const t = dm(), n = Vi((() => {
                ...
                return e.split(".")
            })), o = pt({hello: "Hello World !", text: "一个建立于 21 世纪的小站，存活于互联网的边缘"}), r = () => {
...
const wb = {
        ...
        [
            ...
            },
            {
                icon: "Compass",
                name: "服务状态",
                link: "https://121.62.22.121:10852/p_tools/systemstatus/"
            },
            {
                icon: "Book",
                name: "数据平台",
                link: "http://www.appc.net.cn/"
            },
            {
                icon: "Fire",
                name: "工具箱",
                link: "https://121.62.22.121:10852/p_tools/"
            },
            {
                icon: "Fire",
                name: "笔记归档",
