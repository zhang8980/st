...
const {c: Am} = function (e = {}) {
    ...
    Wm = Vm((() => ai("div", {class: "loader-section section-right"}, null, -1))), Um = zm({
        __name: "Loading", setup(e) {
            ...
            }, [ai("div", Nm, [$m, ai("div", Dm, [ai("span", Fm, J(At("Jerry.zhang")), 1), Rm])]), Hm, Wm], 2))
        }
    ...
    Eg = {class: "content"}, Mg = {class: "text"}, Lg = zm({
        __name: "Message", setup(e) {
            const t = dm(), n = Vi((() => {
                const e = "Working.Notes";
                if (e.startsWith("http://") || e.startsWith("https://")) {
                    return e.replace(/^(https?:\/\/)/, "").split(".")

                }
                return e.split(".")
            })), o = pt({hello: "Hello World !", text: "勤能补拙,以拙求进,致力于效率提升..."}), r = () => {
            ...
            })), (e, t) => (Yr(), Qr("div", kg, [ai("div", Sg, [ai("img", {
                class: "logo-img",
                src: At("/homepage/images/icon/logo.png"),
                alt: "logo"
            }, null, 8, Cg), ai("div", {
                class: G({
                    name: !0,
    ...
    }, [["__scopeId", "data-v-03d4b6aa"]]), Og = [{name: "Gitee", icon: "/homepage/images/icon/gitee.png", tip: "", url: ""
    }, {name: "BiliBili", icon: "/homepage/images/icon/bilibili.png", tip: "", url: "#"
    }, {name: "QQ", icon: "/homepage/images/icon/qq.png", tip: "", url: "#"
    }, {name: "Email", icon: "/homepage/images/icon/email.png", tip: "", url: "#"
    }, {name: "Twitter", icon: "/homepage/images/icon/twitter.png", tip: "", url: "#"}, {
        name: "Telegram", icon: "/homepage/images/icon/telegram.png", tip: "", url: "#"}], Ag = {class: "social"}, Pg = {class: "link"}, jg = ["href", "onMouseenter"], Bg = ["src"], Ig = {class: "tip"},
    zg = zm({
        __name: "SocialLinks", setup(e) {
            ...
            return (e, n) => (Yr(), Qr("div", Ag, [ai("div", Pg, [(Yr(!0), Qr(Rr, null, Po(At(Og), (e => (Yr(), Qr("a", {
                ...
                onMouseleave: n[0] || (n[0] = e => t.value = "")
            }, [ai("img", {
                class: "icon",
                src: e.icon,
                height: "24"
...
const Jg = (e => (yn("data-v-28c8de00"), e = e(), bn(), e))((() => ai("span", null, "打开音乐播放器", -1))),
    ...
    iy = {class: "sm-hidden"}, ay = {key: 1, class: "weather"}, sy = [ai("span", null, "天气数据获取失败", -1)], ly = {
        __name: "Weather", setup(e) {
            const t = "db99097ecdf0a66a7f03e14a2199f0ef", n = pt({
                ...
                try {
                    ...
                    console.error("天气信息获取失败:" + e), r("天气信息获取失败")
                }
            }, r = e => {
...
const wb = {
        ...
        [
            ...
            },
            {
                icon: "Book",
                name: "数据平台",
                link: "http://a.appc.net.cn/p_tools/web_url/a/"
            },
            {
                icon: "Fire",
                name: "笔记归档",
            ...
            },
            {
                icon: "Fire",
                name: "剪贴工具",
                link: "http://a.appc.net.cn/pm/note.html"
            },
            {
                icon: "Compass",
                name: "服务状态",
                link: "http://a.appc.net.cn/p_tools/6.Web_Monitor/"
            },
            {
                icon: "LaptopCode",
                name: "备用线路",
                link: "http://a.appc.net.cn/p_tools/web_url/b/"
            }
        ],
    Sb = e => (yn("data-v-c32f090c"), e = e(), bn(), e), Cb = {key: 0, class: "links"}, _b = {class: "line"},
    Tb = Sb((() => ai("span", {class: "title"}, "网站列表", -1))), Eb = ["onClick"], Mb = {class: "name text-hidden"},
    Lb = Sb((() => ai("div", {class: "swiper-pagination"}, null, -1))), Ob = {
        ...
        __name: "Background", emits: ["loadComplete"], setup(e, {emit: t}) {
            const n = dm(), o = Et(null), r = Et(null), i = t, a = Math.floor(10 * Math.random() + 1), s = () => {
                r.value = setTimeout((() => {
                ...
                console.error("壁纸加载失败：", o.value)
                    , o.value = `/homepage/images/background${a}.jpg`
            };
            return So((() => {
                var e;
                0 == (e = n.coverType) ? o.value = `/homepage/images/background${a}.jpg` : 1 == e ? o.value = "https://api.dujin.org/bing/1920.php" : 2 == e ? o.value = "https://api.aixiaowai.cn/gqapi/gqapi.php" : 3 == e && (o.value = "https://api.aixiaowai.cn/api/api.php")
            })), To((() => {
    ...
    Rb = {key: 0, href: "#", target: "_blank"}, Hb = {key: 1, class: "lrc"}, Wb = ["innerHTML"],
    Ub = zm({
        __name: "Footer", setup(e) {
            const t = dm(), n = (new Date).getFullYear();
            Et("2024-05-19");
            const o = Et("jerry_blog");
            return Et("Jerry.zhang"), Vi((() => {
                const e = "appc.net.cn";
                ...
                default: wn((() => [At(t).playerState && At(t).playerLrcShow ? (Yr(), Qr("div", Hb, [si(Xi, {
                    ...
                    }, null, 8, Wb), si(At($v), {theme: "filled", size: "18", fill: "#efefef"})]))])), _: 1
                })])) : (Yr(), Qr("div", $b, [ai("span", null, " Copyright © " + J(At(n)), 1), ai("span", Db, [ui("  Jerry * "), ai("a", {
                    href: At(Nb).github,
                    target: "_blank"
                }, " Porered by ", 8, Fb)]), At(o) ? (Yr(), Qr("a", Rb, " & " + J(At(o)), 1)) : di("", !0)]))])), _: 1
            })], 2))
        }
            ...
            return So((() => {
                i.value = setInterval((() => {
                    n.value = Kv(), o.value && (r.value = (e => {
                        ...
                        return o >= 1 ? `本站已经存活了 ${Math.floor(o)} 年 ${Math.floor(n % 12)} 月 ${Math.round(t % 30)} 天` : n >= 1 ? `本站已经苟活了 ${Math.floor(n)} 月 ${Math.round(t % 30)} 天` : `本站已经苟活了 ${Math.round(t)} 天`
                    })(new Date(o.value)))
                }), 1e3)
            })), To((() => {
                    ...
                    default: wn((() => [si(l, {
                        ...
                        default: wn((() => [ai("div", bw, [ai("span", ww, J(At(o)[0]), 1), ai("span", xw, "." + J(At(o)[1]), 1)]), ai("div", kw, [ai("div", Sw, "v " + J(At(Nb).version), 1), si(a, {
                            ...
                            default: wn((() => [si(At(jv), {
                                ...
                                size: "24",
                                onClick: i[1] || (i[1] = e => {
                                    return t = At(Nb).git, void window.open(t);
                                    var t
                                })
                            })])), _: 1
                        })]), si(s, {class: "update"}, {
